...
const CACHE = "library-static-f1447516e8";
...
self.addEventListener("message", (e) => {
  ...
  if (e.ports && e.ports[0]) e.ports[0].postMessage({ stamp: "f1447516e8" });
  else if (e.source) e.source.postMessage({ stamp: "f1447516e8" });
});
