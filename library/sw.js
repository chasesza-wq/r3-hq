...
const CACHE = "library-static-7d10696fb1";
...
self.addEventListener("message", (e) => {
  ...
  if (e.ports && e.ports[0]) e.ports[0].postMessage({ stamp: "7d10696fb1" });
  else if (e.source) e.source.postMessage({ stamp: "7d10696fb1" });
});
